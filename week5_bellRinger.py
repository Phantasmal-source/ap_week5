...
last_c_index = print(magic.rindex('r'))

# Advanced Slicing:
# Given the string alphabet = 'abcdefghijklmnopqrstuvwxyz',
alphabet = 'abcdefghijklmnopqrstuvwxyz'
# a. Extract the letters 'hij'.
hij = print(alphabet.index('h')) #output 7
...
dream_a_have_I = print(I_have_a_dream[::-1])
...
fun = "Python is fun. Fun is good. Good is subjective."

# a. Extract the word 'subjective' without knowing its exact position.
sub = print(fun.find("subjective"))
# b. Extract every third letter.
print(fun[::3])
# c. Reverse the positions of the words, but keep the characters in each word in the same order.
words = fun.split() #split the string into words
print(words)
...
nu_life = new_life.replace("plans", "mistakes")
print(nu_life)
